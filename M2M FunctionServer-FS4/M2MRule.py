...
_g_M2MRulesMappingList = [{"RuleID": "1", "InputNode": "NODE-01_IS", "InputIO": "SW1",
                           "OutputNode": "NODE-Manager", "OutputIO": "AirConditioner03", "TargetValueOverride": "Comfort Level"},

                          {"RuleID": "2", "InputNode": "NODE-02_IS", "InputIO": "SW1",
                           "OutputNode": "NODE-Manager", "OutputIO": "AirConditioner03", "TargetValueOverride": "Comfort Level"}

#                          {"RuleID": "3", "InputNode": "NODE-02_IS", "InputIO": "SW1",
#                           "OutputNode": "NODE-04_AC", "OutputIO": "AirConditioner04", "TargetValueOverride": "Comfort Level"},

#                          {"RuleID": "4", "InputNode": "NODE-05_OS", "InputIO": "SW1",
#                           "OutputNode": "NODE-04_AC", "OutputIO": "AirConditioner04", "TargetValueOverride": "Comfort Level"}
                          ]
