...
class DecisionAction():
    def Judge(self, _obj_json_msg):
        ...
        if (spreate_obj_json_msg["Control"] == "M2M_REQTOPICLIST"):
            ...
            #pe
            m2mfsmrules.replyM2MTopicToNode(spreate_obj_json_msg["FunctionServer"], spreate_obj_json_msg["Node"])
            ...
            #pe
            m2mfsmrules.replyM2MRulesAll(spreate_obj_json_msg["FunctionServer"])
